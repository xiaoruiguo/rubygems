...
You can upgrade or downgrade to the latest release version with:
  ...
  def get_hosts_for(name)
    ...
    default_gem_server = nil
    if gem_data.spec.metadata.has_key?("default_gem_server")
      default_gem_server = gem_data.spec.metadata["default_gem_server"]
    end
